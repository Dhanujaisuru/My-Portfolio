export default function Button({
  ...
  const variants = {
    ...
    secondary:
      "font-display normal-case py-[0.75rem] px-7 bg-[rgba(255,255,255,0.04)] text-white-base text-[0.85rem] border border-[var(--purple-glow)] border-[rgba(255,255,255,0.08)] rounded-[12px] transition-all duration-300 hover:-translate-y-[3px] hover:border-violet-500 hover:shadow-[0_12px_40px_rgba(139,92,246,0.35)]",

    nav: 
      "font-display normal-case px-[1.25rem] py-[0.5rem] leading-none bg-gold-base text-[#0B1F3B] text-[0.8rem] tracking-[0.02em] rounded-[8px] border border-gold-base shadow-none hover:bg-gold-base hover:text-[#0B1F3B] hover:translate-y-[-1px] hover:shadow-[0_4px_20px_rgba(245,197,66,0.35)] active:translate-y-0",
